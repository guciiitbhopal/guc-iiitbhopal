...
const Contact = () => {
  return (
    <div className="lg:flex">
      <div>
        <h1 className="sm:mx-20 lg:mx-28 xl:mx-24 mx-12 sm:text-4xl text-2xl text-center sm:text-left py-5 pt-14 font-mono">Connect with us</h1>
        <div className="sm:flex sm:mx-9 mx-7 md:text-base text-sm">
          <ul className="mx-14 ">
            <li className="text-center md:text-left my-5 hover:text-slate-400">
              ...
              <a className="lg:mx-2 mx-4" href="https://github.com/guciiitbhopal">
                Github
              </a>
            </li>
            <li className="text-center md:text-left my-5 hover:text-slate-400">
          ...
          <ul  className="mx-14 sm:mx-0 ">
            <li className="text-center md:text-left my-5 hover:text-slate-400">
              ...
              <a className="lg:mx-2 mx-4" href="https://twitter.com/GUCIIITBhopal">
                Twitter
              </a>
            </li>
            <li className="text-center md:text-left my-5 hover:text-slate-400">
            ...
            <li className="text-center md:text-left my-5 hover:text-slate-400">
              ...
              <a className="lg:mx-2 mx-4" href="https://www.instagram.com/guc_iiitbhopal/">
                Instagram
              </a>
            </li>
          </ul>
